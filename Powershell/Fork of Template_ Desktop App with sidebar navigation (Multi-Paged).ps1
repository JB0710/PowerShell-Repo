...
$Xaml = @"
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="1000" Height="600" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="0,0,0,0" Background="#35333a" BorderThickness="0" BorderBrush="#666374" Foreground="#514e5d" OpacityMask="#5b586d" Name="TestWPF1" WindowStartupLocation="CenterScreen" ResizeMode="CanResizeWithGrip" Title="Tabbed Template" WindowChrome.IsHitTestVisibleInChrome="True"><Window.Resources>
	<ResourceDictionary>
  ...
  <Grid Background="#262335" ShowGridLines="False" Name="MainGrid">
    ...
    <Border BorderBrush="Black" BorderThickness="0" Grid.Row="0" Grid.Column="0" Grid.ColumnSpan="2" Background="#241b2f">
      <TextBox HorizontalAlignment="Center" VerticalAlignment="Center" Height="20" Width="300" TextWrapping="Wrap" Text="🔎 Search" Margin="0,0,0,0"/>
    </Border>
    <StackPanel Background="#241b2f" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="0">
      <Image Height="100" Width="170" Name="Icon" SnapsToDevicePixels="True" Source="C:\OEM\src\png\ae_logo.png" Margin="0,10,0,10"/>
      <Button Content="Tab 1" VerticalAlignment="Top" Height="40" Background="#241b2f" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab1BT"/>
      <Button Content="Tab 2" VerticalAlignment="Top" Height="40" Background="#241b2f" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab2BT"/>
      <Button Content="Tab 3" VerticalAlignment="Top" Height="40" Background="#241b2f" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab3BT"/>
      <Button Content="Tab 4" VerticalAlignment="Top" Height="40" Background="#241b2f" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab4BT"/>
      <Button Content="Tab 5" VerticalAlignment="Top" Height="40" Background="#241b2f" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab5BT"/>
    </StackPanel>
    <TabControl Grid.Row="1" Grid.Column="1" Padding="-1" Name="TabNav" SelectedIndex="0">
      <TabItem Header="Tab 1" Visibility="Collapsed" Name="Tab1">
        <Grid Background="#262335">
          ...
          <TextBlock Name="SourceTB" Grid.Column="0" HorizontalAlignment="Center" VerticalAlignment="Top" TextWrapping="Wrap" Text="Source" FontSize="14" FontWeight="Bold" Height="21" Foreground="#ffffff"/>
          <TextBlock Name="DestinationTB" Grid.Column="1" HorizontalAlignment="Center" VerticalAlignment="Top" TextWrapping="Wrap" Text="Destination" FontSize="14" FontWeight="Bold" Height="21" Foreground="#ffffff"/>
        </Grid>
      </TabItem>
      <TabItem Header="Tab 2" Visibility="Collapsed" Name="Tab2">
        <Grid Background="#262335">
          <TextBlock HorizontalAlignment="Center" VerticalAlignment="Top" TextWrapping="Wrap" Text="Tab 2" FontSize="14" FontWeight="Bold" Height="21" Foreground="#ffffff"/>
        </Grid>
      </TabItem>
      ...
      <TabItem Header="Tab 5" Visibility="Collapsed" Name="Tab5">
        <Grid Background="#262335">
          <TextBlock HorizontalAlignment="Center" VerticalAlignment="Top" TextWrapping="Wrap" Text="Tab 5" FontSize="14" FontWeight="Bold" Height="21" Foreground="#ffffff"/>
        </Grid>
      </TabItem>
    </TabControl>
  </Grid>
