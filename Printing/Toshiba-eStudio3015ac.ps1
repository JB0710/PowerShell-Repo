...
$driverDir = "Toshiba-eStudio3015ac"
$driverFile = "Toshiba-eStudio3015ac.zip"
$PrinterName = "Toshiba-eStudio3015ac"
$printDriverName = "TOSHIBA Universal Printer 2"
...
$Url = "https://www.kljwtech.net/drivers/printers/toshiba/$driverFile"
