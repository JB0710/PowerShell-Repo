...
$driverDir = "ricoh-mpc407"
$driverFile = "ricoh-mpc407.zip"
$PrinterName = "Ricoh MP C407"
$printDriverName = "SAVIN MP C407 PCL 6"
...
$Url = "https://www.kljwtech.net/drivers/printers/ricoh/$driverFile"
