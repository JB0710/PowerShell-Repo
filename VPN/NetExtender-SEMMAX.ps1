...
$SSLVPNServer = Read-InputBoxDialog -Message "SSL VPN Server IP" -WindowTitle "SSL VPN Profile" -DefaultText "174.99.242.110:4433"
$SSLVPNDomain = Read-InputBoxDialog -Message "SSL VPN Domain" -WindowTitle "SSL VPN Profile" -DefaultText "SEMMAX.local"
