...
$SSLVPNServer = Read-InputBoxDialog -Message "SSL VPN Server IP" -WindowTitle "SSL VPN Profile" -DefaultText "24.248.150.202:4433"
$SSLVPNDomain = Read-InputBoxDialog -Message "SSL VPN Domain" -WindowTitle "SSL VPN Profile" -DefaultText "sunflower.local"
