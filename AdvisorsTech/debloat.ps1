Add-OutputBoxLine -Message "Debloating Windows"

Add-OutputBoxLine -Message "Disabling Telemetry..."
Set-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\Windows\DataCollection" -Name "AllowTelemetry" -Type DWord -Value 0

Add-OutputBoxLine -Message "Disabling Wi-Fi Sense..."
...
Add-OutputBoxLine -Message "Disabling SmartScreen Filter..."
Set-ItemProperty -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer" -Name "SmartScreenEnabled" -Type String -Value "Off"
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\AppHost" -Name "EnableWebContentEvaluation" -Type DWord -Value 0

Add-OutputBoxLine -Message "Disabling Bing Search in Start Menu..."
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Search" -Name "BingSearchEnabled" -Type DWord -Value 0

Add-OutputBoxLine -Message "Disabling Location Tracking..."
Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Overrides\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}" -Name "SensorPermissionState" -Type DWord -Value 0
Set-ItemProperty -Path "HKLM:\System\CurrentControlSet\Services\lfsvc\Service\Configuration" -Name "Status" -Type DWord -Value 0

Add-OutputBoxLine -Message "Disabling Feedback..."
...
Add-OutputBoxLine -Message "Disabling Advertising ID..."
...
Add-OutputBoxLine -Message "Disabling Cortana..."
...
Add-OutputBoxLine -Message "Restricting Windows Update P2P only to local network..."
...
Add-OutputBoxLine -Message "Removing AutoLogger file and restricting directory..."
...
Add-OutputBoxLine -Message "Stopping and disabling Diagnostics Tracking Service..."
Stop-Service "DiagTrack"
Set-Service "DiagTrack" -StartupType Disabled

Add-OutputBoxLine -Message "Disabling Firewall..."
Set-NetFirewallProfile -Profile * -Enabled False

Add-OutputBoxLine -Message "Disabling Windows Defender..."
Set-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\Windows Defender" -Name "DisableAntiSpyware" -Type DWord -Value 1

Add-OutputBoxLine -Message "Disabling Windows Update automatic restart..."
Set-ItemProperty -Path "HKLM:\Software\Microsoft\WindowsUpdate\UX\Settings" -Name "UxOption" -Type DWord -Value 1

Add-OutputBoxLine -Message "Stopping and disabling Home Groups services..."
Stop-Service "HomeGroupListener"
Set-Service "HomeGroupListener" -StartupType Disabled
Stop-Service "HomeGroupProvider"
Set-Service "HomeGroupProvider" -StartupType Disabled

Add-OutputBoxLine -Message "Disabling Remote Assistance..."
Set-ItemProperty -Path "HKLM:\System\CurrentControlSet\Control\Remote Assistance" -Name "fAllowToGetHelp" -Type DWord -Value 0

Add-OutputBoxLine -Message "Enabling Remote Desktop w/o Network Level Authentication..."
...
Add-OutputBoxLine -Message "Hiding Search Box / Button..."
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Search" -Name "SearchboxTaskbarMode" -Type DWord -Value 0

Add-OutputBoxLine -Message "Showing known file extensions..."
...
Add-OutputBoxLine -Message "Changing default Explorer view to `"Computer`"..."
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "LaunchTo" -Type DWord -Value 1

Add-OutputBoxLine -Message "Showing Computer shortcut on desktop..."
...
Add-OutputBoxLine -Message "Removing Music icon from computer namespace..."
Remove-Item -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{3dfdf296-dbec-4fb4-81d1-6a3438bcf4de}" -Recurse -ErrorAction SilentlyContinue
Remove-Item -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{1CF1260C-4DD0-4ebb-811F-33C572699FDE}" -Recurse -ErrorAction SilentlyContinue

Add-OutputBoxLine -Message "Removing Pictures icon from computer namespace..."
Remove-Item -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{24ad3ad4-a569-4530-98e1-ab02f9417aa8}" -Recurse -ErrorAction SilentlyContinue
Remove-Item -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{3ADD1653-EB32-4cb0-BBD7-DFA0ABB5ACCA}" -Recurse -ErrorAction SilentlyContinue

Add-OutputBoxLine -Message "Removing Videos icon from computer namespace..."
Remove-Item -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{f86fa3ab-70d2-4fc7-9c99-fcbf05467f3a}" -Recurse -ErrorAction SilentlyContinue
Remove-Item -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{A0953C92-50DC-43bf-BE83-3742FED03C9C}" -Recurse -ErrorAction SilentlyContinue

Add-OutputBoxLine -Message "Removing 3D Objects icon from computer namespace..."
Remove-Item -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}" -Recurse -ErrorAction SilentlyContinue

Add-OutputBoxLine -Message "Uninstalling OneDrive..."
...
Add-OutputBoxLine -Message "Uninstalling default Microsoft applications..."
...
Add-OutputBoxLine -Message "Uninstalling Work Folders Client..."
dism /online /Disable-Feature /FeatureName:WorkFolders-Client /Quiet /NoRestart

Set Photo Viewer as default for bmp, gif, jpg and png
Add-OutputBoxLine -Message "Setting Photo Viewer as default for bmp, gif, jpg, png and tif..."
If (!(Test-Path "HKCR:"))
{
    New-PSDrive -Name HKCR -PSProvider Registry -Root HKEY_CLASSES_ROOT | Out-Null
}
...
Add-OutputBoxLine -Message "Showing Photo Viewer in `"Open with...`""
If (!(Test-Path "HKCR:"))
{
    New-PSDrive -Name HKCR -PSProvider Registry -Root HKEY_CLASSES_ROOT | Out-Null
}
...
{
    Add-OutputBoxLine -Message "Trying to disable $service"
    Get-Service -Name $service | Set-Service -StartupType Disabled
}

Import-Module -DisableNameChecking $PSScriptRoot\..\lib\New-FolderForced.psm1

Add-OutputBoxLine -Message "Disable automatic download and installation of Windows updates"
...
Add-OutputBoxLine -Message "Disable seeding of updates to other computers via Group Policies"
...
Add-OutputBoxLine -Message "Disable 'Updates are available' message"
...
Add-OutputBoxLine -Message "Elevating privileges for this process"
do { }
until (Elevate-Privileges SeTakeOwnershipPrivilege)

Add-OutputBoxLine -Message "Uninstalling default apps"
$apps = @(
...
Add-OutputBoxLine -Message "Removing run hook for new users"
reg load "hku\Default" "C:\Users\Default\NTUSER.DAT"
reg delete "HKEY_USERS\Default\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" /v "OneDriveSetup" /f
reg unload "hku\Default"

Add-OutputBoxLine -Message "Removing startmenu entry"
Remove-Item -Force -ErrorAction SilentlyContinue "$env:userprofile\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\OneDrive.lnk"

Add-OutputBoxLine -Message "Removing scheduled task"
Get-ScheduledTask -TaskPath '\' -TaskName 'OneDrive*' -ea SilentlyContinue | Unregister-ScheduledTask -Confirm:$false

Add-OutputBoxLine -Message "Restarting explorer"
Start-Process "explorer.exe"

Add-OutputBoxLine -Message "Waiting for explorer to complete loading"
Start-Sleep 10

Add-OutputBoxLine -Message "Removing additional OneDrive leftovers"
...
Add-OutputBoxLine2 -Message "Windows 10 Debloat Complete"