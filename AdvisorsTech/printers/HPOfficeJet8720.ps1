...
$PrinterName = "HP OfficeJet 8720"

#Check to see if directory exists
$FolderName = "C:\OEM\Printers\HP-OfficeJet8720"
...
#Download Drivers
$DriverFolder= "C:\OEM\Printers\HP-OfficeJet8720"
If (Test-Path $DriverFolder){ Remove-Item $DriverFolder -Recurse }

#Xerox Universal Printer
$Url = 'https://www.kljwtech.net/files/drivers/printers/hp-officejet8720.zip' 
...
Invoke-Command {pnputil /add-driver "C:\OEM\Printers\HP-OfficeJet8720\*.inf" /install} 
...
#Install Printer
$portName = $PrinterIP
$printDriverName = "HP OfficeJet Pro 8720"
